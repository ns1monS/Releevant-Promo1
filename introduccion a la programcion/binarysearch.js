...
function binarysearch(array, b) {
    ...
    let derecha = [array[2], array[3]]; // [6, 7]
    
    if (b < derecha[0]) { // el numero esta en el array derecha? comparo b < 
    ...
    } else { // el numero esta en el array derecha
